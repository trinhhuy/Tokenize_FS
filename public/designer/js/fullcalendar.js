...
var ListViewGrid = Grid.extend({
	...
	renderSegList: function(segs) {
		//mol
		var tableEl = $('<table class="fc-list-table"><tr class="fc-list-heading"><td>Date</td><td>Doctor</td><td>Reason</td><td>Status</td><td class="eventsort"><span class="selectwrap"><select><option>SORT BY</option><option>Date (Oldest first)</option><option>Date (Newest first)</option><option>Reason</option><option>Status</option></select></span></td></tr></table>');
...
//mol
	...
	fgSegHtml: function(seg) {
		...
		var status = event.status;
		var doctortitle = event.doctortitle;
		var date = event.start.format('ddd MM/DD/YYYY');
		var timeHtml;
...
//mol
		return '<tr class="' + classes.join(' ') + ' ' + htmlEscape(status) + '">' +
			...
			'<td class="fc-list-item-title ' + view.widgetContentClass + '">' +
				...
				'</a></strong>' +
				 (doctortitle ? '<div class="doctortitle">' + htmlEscape(doctortitle) + '</div>': '') +
			'</td>' +
			...
			'</td>' +
			'<td class="fc-list-item-action"><a href="#/" class="btn light smallbtn apdetailbtn" title="View appointment detail">Detail</a> ' + 
			(status == 'Canceled' ? '': '<a href="#/" class="btn light smallbtn"  title="Cancel appointment">Cancel</a>') +
			'</td>' +
		'</tr>';
	}
