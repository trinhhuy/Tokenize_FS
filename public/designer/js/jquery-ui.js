...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		beforeShowDay: null, // Function that takes a date and returns an array with
			...
			// [2] = cell title <span class="smallnote">Optional</span>, e.g. $.datepicker.noWeekends
...
$.extend( Datepicker.prototype, {
	 ...
	 *					shortYearCutoff  number - the cutoff year for determining the century <span class="smallnote">Optional</span>
	 *					dayNamesShort	string[7] - abbreviated names of the days from Sunday <span class="smallnote">Optional</span>
	 *					dayNames		string[7] - names of the days from Sunday <span class="smallnote">Optional</span>
	 *					monthNamesShort string[12] - abbreviated names of the months <span class="smallnote">Optional</span>
	 *					monthNames		string[12] - names of the months <span class="smallnote">Optional</span>
