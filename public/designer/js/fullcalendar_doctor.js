...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	// Renders a visual indication of an event or external element being dragged.
	// `eventLocation` has zoned start and end <span class="smallnote">Optional</span>
...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ')  + ' ' + htmlEscape(status) + '"' +
				(event.url ?
...
var ListViewGrid = Grid.extend({
	...
	renderSegList: function(segs) {
		//mol
		var tableEl = $('<table class="fc-list-table"><tr class="fc-list-heading"><td>Date</td><td>Patient</td><td>ZIP code</td><td>Reason</td><td>Status</td><td class="eventsort"><span class="selectwrap"><select><option>SORT BY</option><option>Date (Oldest first)</option><option>Date (Newest first)</option><option>ZIP Code</option><option>Reason</option><option>Status</option></select></span></td></tr></table>');
...
//mol
			...
			'<td class="' + view.widgetHeaderClass + '" colspan="3">' +
				(mainFormat ?
					view.buildGotoAnchorHtml(
						...
						htmlEscape(dayDate.format('ddd MM/DD/YYYY')) 
					) :
					'') +
				//(altFormat ?
				//	view.buildGotoAnchorHtml(
				...
				//	'') +
			'</td>' +
			'<td class="' + view.widgetHeaderClass + '">Reason' +
			'</td>' +
			'<td class="' + view.widgetHeaderClass + '" colspan="2">Status' +
			'</td>' +
		'</tr>';*/
	},
	...
	fgSegHtml: function(seg) {
		...
		var date = event.start.format('MM/DD/YYYY');
		var timeHtml;
		...
		//}
//mol
		return '<tr class="' + classes.join(' ') + ' ' + htmlEscape(status) + '">' +
			(timeHtml ?
			...
			'<td class="fc-list-item-title ' + view.widgetContentClass + '">' +
				'<strong><a href="profile.html" title="View profile">' +
					htmlEscape(seg.event.title) +
				'</a></strong>' +
				 (reason ? '<div class="payment"><strong>Payment:</strong> ' + htmlEscape(payment) + '</div>': '') + 
			'</td>' +
			'<td class="fc-list-item-zipcode">' +
				(reason ? htmlEscape(zipcode): '') + 
			'</td>' +
			'<td class="fc-list-item-reason">' +
				(reason ? htmlEscape(reason): '') + 
			'</td>' +
			'<td class="fc-list-item-status">' +
				 (status ? htmlEscape(status): '') + 
			'</td>' +
			'<td class="fc-list-item-action"><a href="#/" class="btn light smallbtn apdetailbtn" title="View appointment detail & manage"><i class="fa fa-cog"></i> Manage</a> ' + 
			//(status == 'Booked' ? '<a href="#/" class="btn light smallbtn"  title="Quick confirm appointment">Confirm</a>': '') +
			'</td>' +
		'</tr>';
	}
